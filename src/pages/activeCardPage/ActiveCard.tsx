...
export default function ActiveCard() {
    ...
    return (
        <>
            {!loaded && (<Loading/>)}
            {!!loaded && (<article style={{ margin: "0 50px 70px 25px"}}>
                ...
                <div className='card__text'>
                    <span>Full text of the article is available at the official source:</span> <a href={activeCard?.url} rel="noopener noreferrer" target="_blank">Link to the source</a> <br/> 
                </div>
            </article>)}
        </>
    );
